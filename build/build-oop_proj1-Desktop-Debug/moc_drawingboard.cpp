...
void DrawingBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DrawingBoard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawingBoard::ChangedSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DrawingBoard::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DrawingBoard.data,
    qt_meta_data_DrawingBoard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void DrawingBoard::ChangedSignal()
{
